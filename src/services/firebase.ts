...
export const DB_COLLECTIONS = {
  ...
  TICKETS: 'tickets',
  ALERTS: 'alerts',
  EMERGENCY_ALERTS: 'emergencyAlerts', // Added from sos.tsx
  CHECKINS: 'checkIns', // Added from QRBoardingScreen
  NOTIFICATIONS: 'notifications' // Added from notification.tsx
};
...
export const databaseService = {
  ...
  addCheckIn: async (userId: string, busId: string, checkInData: any) => {
    // Implementation for adding check-in
...
// Import all Firebase database functions
import { 
  ref, 
  push, 
  set, 
